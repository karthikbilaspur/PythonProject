...
def main():
    parser = argparse.ArgumentParser(description='TOTP Generator and Verifier')
    ...
    if args.verify:
        result = verify_totp(secret_key, args.verify, args.algorithm, args.digits, args.interval, args.window)
        if result:
